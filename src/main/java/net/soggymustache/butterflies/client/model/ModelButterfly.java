...
public class ModelButterfly extends ModelBase {
    ...
    public ModelButterfly() {
        ...
        this.wingRight1.setRotationPoint(-3.0F, -1.0F, 0.0F);
        this.wingRight1.addBox(-8.0F, 0.0F, -8.0F, 10, 0, 8, 0.0F);
        ...
        this.wingRight2.setRotationPoint(-3.0F, -1.0F, 0.0F);
        this.wingRight2.addBox(-7.0F, 0.0F, 0.0F, 9, 0, 7, 0.0F);
